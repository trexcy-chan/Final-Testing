        ...
        async editreq(){
          ...
          if(this.editcertype=='BARANGY CLEARANCE'){
            ...
            if(this.reqstat == 'Released'){
              ...
              const addedDocs = await setDoc(doc(db, "Clearance Requests",currendID ),{currendID, BCdate, BCtime, BCfirst, BCmiddle, BClast, BCsuffix, BCpurok, BCcitizenship, BCstatus, BCage, BCquantity, BCcedula, BCtotalcost,BCpurpose,BCreqstat,BCreason,m,d,y});           
              console.log(addedDocs);
            }
            alert("Changes Saved");
            ...
            alert("Released");
              ...
              const addedDocs = await setDoc(doc(db, "Permit Requests",currendID ),{currendID, BPdate, BPtime, BPfirst, BPmiddle, BPlast, BPsuffix, BPbname, BPvenue, BPnature, BPcedula, BPpurpose, BPtotalcost, BPreqstat, BPeffectivity, BPedate,BPreason,m,d,y});            
              console.log(addedDocs);
            }
            alert("Changes Saved");
