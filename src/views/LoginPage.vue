...
<script>
import { residentsColRef } from "../firebase";
    ...
    methods:{
        async login() {
            ...
            residentSnapshot.forEach((resident) =>{
                ...
                if((residentData.phonenumber == this.phonenumber) && (residentData.password == this.password)){
                    //alert(residentData.userID);
                    this.$router.push(`/homepage/${residentData.userID}`);
                }
